    ...
    <div class="nav-links" id="nav-links">
      ...
      <div class="nav-dropdown">
        ...
        <div class="nav-dropdown-menu" id="dd-secciones">
          <a href="secciones.html" class="nav-dropdown-item" style="font-weight:600;border-bottom:1px solid #eee;">Ver todas las opciones</a>
          <a href="competicion.html" class="nav-dropdown-item">Atletismo pista</a>
          <a href="natacion.html" class="nav-dropdown-item">Natación</a>
          <a href="cubo.html" class="nav-dropdown-item">Entrenamiento funcional · Cubo</a>
          ...
          <a href="calendario.html" class="nav-dropdown-item" style="border-top:1px solid #eee;margin-top:4px;padding-top:9px;">Calendario</a>
        </div>
      </div>
      <div class="nav-dropdown">
